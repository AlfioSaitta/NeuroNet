...
from core.config import JWT_ALGORITHM, JWT_SECRET, ACCESS_TOKEN_EXPIRE_MINUTES, COOKIE_SECURE
...
async def get_current_user(request: Request) -> dict | None:
    ...
    from api.auth.user_manager import user_manager, ensure_admin_exists  # defer import
    ...
    if user_manager is None:
        ...
        from api.auth.user_manager import user_manager  # re-import after init
        if user_manager is None:
            return None
...
async def login(body: LoginRequest):
    ...
    """
    from api.auth.user_manager import user_manager, ensure_admin_exists
