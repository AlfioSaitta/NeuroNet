...
os.environ["OPENAI_API_KEY"] = "sk-jarvis-internal"  # chiave fittizia per Mem0/OpenAI SDK — bypassata dal middleware per localhost
...
MEM0_CONFIG = {
    ...
    "llm": {
        "provider": "openai",
        "config": {"model": MODEL_ID, "temperature": 0.0, "openai_base_url": "http://127.0.0.1:8000/v1"}
    },
    "embedder": {
        "provider": "openai",
        "config": {"model": EMBEDDING_MODEL, "openai_base_url": "http://127.0.0.1:8000/v1"}
    }
}
...
try:
    from graph.synaptiq_engine import synaptiq_engine, is_synaptiq_available, get_synaptiq_version  # noqa: F401
